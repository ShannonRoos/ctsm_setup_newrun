...
#include "shr_assert.h"
  ...
  real(r8), public, parameter :: tcrit = 303.15_r8 ! 30 degrees
  real(r8), public, parameter :: tmax = 318.15_r8  ! 45 degrees
  ...
  subroutine calc_HS_factor(HS_factor, HS_ndays, t_veg_day, croplive)
    ...
    if (HS_ndays >= day_min .and. croplive .and. t_veg_day >= tcrit) then
      if (t_veg_day <= tmax ) then
          HS_factor = 5._r8 !4._r8 - (1._r8 - (t_veg_day - tcrit)/2._r8)
      else
          HS_factor = 5._r8
      end if
    else
